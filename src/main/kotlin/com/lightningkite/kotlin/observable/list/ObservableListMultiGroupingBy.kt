...
class ObservableListMultiGroupingBy<E, G, L>(
    ...
    inner private class QueuedOnRemoveCall(val groupList: InnerList, val element: E, val index: Int) : Comparable<QueuedOnRemoveCall> {
    ...
    inner private class QueuedOnAddCall(val groupList: InnerList, val element: E, val index: Int) : Comparable<QueuedOnAddCall> {
    ...
    inner private class QueuedOnChangeCall(val groupList: InnerList, val oldElement: E, val element: E, val index: Int) : Comparable<QueuedOnChangeCall> {
