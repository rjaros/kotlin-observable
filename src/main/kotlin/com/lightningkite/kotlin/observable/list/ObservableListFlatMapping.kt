...
class ObservableListFlatMapping<S, E>(val source: ObservableList<S>, val mapper: (S) -> ObservableList<E>) : ObservableList<E>, Disposable {
    ...
    override fun iterator(): MutableIterator<E> = object : MutableIterator<E> {
        ...
        override fun next(): E {
            if (!hasNext()) throw Exception("No more items")
    ...
    override val onUpdate = ObservablePropertyReference<ObservableList<E>>({ this@ObservableListFlatMapping }, { throw Exception("IllegalAccess") })
