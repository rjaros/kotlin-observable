...
abstract class ObservableListIndicies<E>(val source: ObservableList<E>) : ObservableList<E> {
    ...
    override val onUpdate = ObservablePropertyReference<ObservableList<E>>({ this }, { throw Exception("IllegalAccess") })
    ...
    @Suppress("UNCHECKED_CAST")
    override fun removeAll(elements: Collection<E>): Boolean = throw Exception("IllegalAccess")

    override fun retainAll(elements: Collection<E>): Boolean = throw Exception("IllegalAccess")
